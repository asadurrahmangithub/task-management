                            ...
                            <div class="col-7 mx-auto">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h2 class="text-info text-center mb-3">Add Project Information</h4>
                                        ...
                                        <form action="{{route('project.store')}}" method="post">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="project_name" type="text" placeholder="Enter Your Project Name" id="example-text-input">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="project_description" class="form-control" id="" cols="30" rows="7"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                <input class="form-control" name="submit_date" type="date">
                                                </div>
                                            </div>
