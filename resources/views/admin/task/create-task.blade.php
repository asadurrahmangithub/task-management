                            ...
                            <div class="col-7 mx-auto">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h2 class="text-info text-center mb-3">Add Task Project Information</h4>
                                        ...
                                        <form action="{{route('task.store')}}" method="post">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="task_name" type="text" value="{{old('task_name')}}" placeholder="Enter Your Task Project Name" id="example-text-input">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="task_description" class="form-control" id="" cols="30" rows="7">{{old('task_description')}}</textarea>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                <input class="form-control" name="end_time" value="{{old('end_time')}}" type="time">
