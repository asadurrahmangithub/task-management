...
<div class="row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                            <h2 class="mt-4">Task Manage Table</h4>
                                                <button type="button" class="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#addTaskModal">
                                                    Add Task Product
                                                  </button>
                                    </div>
                        ...
                        <div class="modal fade " id="addTaskModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="width: 100%">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h2 class="text-info text-center mb-5">Add Task Project</h4>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" id="task_name" type="text" value="{{old('task_name')}}" placeholder="Enter Your Task Project Name" id="example-text-input">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                <input class="form-control" id="date" value="{{old('date')}}" type="date">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                <input class="form-control" id="start_time" value="{{old('start_time')}}" type="time">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                <input class="form-control" id="end_time" value="{{old('end_time')}}" type="time">
                        ...
                        <div class="modal fade " id="updateTaskProjectModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="width: 100%">
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-lg-down modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h2 class="text-info text-center mb-5">Update Task Project</h4>
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Task Name</label>
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" id="e_task_name" type="text" value="{{old('task_name')}}" placeholder="Enter Your Task Project Name" id="example-text-input">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label class="col-sm-2 col-form-label">Date</label>
                                                                <div class="col-sm-10">
                                                                <input class="form-control" id="e_date" value="{{old('date')}}" type="date">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label class="col-sm-2 col-form-label">Start Time</label>
                                                                <div class="col-sm-10">
                                                                <input class="form-control" id="e_start_time" value="{{old('start_time')}}" type="time">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label class="col-sm-2 col-form-label">End Time</label>
                                                                <div class="col-sm-10">
                                                                <input class="form-control" id="e_end_time" value="{{old('end_time')}}" type="time">
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
...
let url = window.location.origin
        function table_data_row(data) {
                ...
                $.each( data, function( key, value ) {
                    ...
                    rows = rows + '<td data-id="'+value.id+'" class="text-center">';
                    rows = rows + '<a class="btn btn-info text-light" id="editTaskProject" data-id="'+value.id+'" data-bs-toggle="modal" data-bs-target="#updateTaskProjectModal">Edit</a> ';
