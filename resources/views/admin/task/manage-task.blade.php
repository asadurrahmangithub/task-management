                                    ...
                                    <div class="card-body">
                                        ...
                                        <h2 class="text-info text-center mb-5">Add Task Project</h4>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="task_name" type="text"
                                                        value="{{ old('task_name') }}"
                                                        placeholder="Enter Your Task Project Name" id="example-text-input">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="date" value="{{ old('date') }}"
                                                        type="date">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="end_time" value="{{ old('end_time') }}"
                                                        type="time">
    ...
    <script>
        ...
        function table_data_row(data) {
            ...
            $.each(data, function(key, value) {
                ...
                rows = rows + '<td data-id="' + value.id + '" class="text-center">';
                rows = rows + '<a class="btn btn-info text-light" id="editTaskProject" data-id="' + value.id +
