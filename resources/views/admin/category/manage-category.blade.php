                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h2 class="text-info text-center mb-5">Update Category Section</h4>
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="name" class="col-sm-4 col-form-label">Category Name</label>
                                                                <div class="col-sm-8">
                                                                    <input class="form-control" type="text" placeholder="Enter Your Category Name" id="e_name">
...
<script>
        ...
        function table_data_row(data) {
                ...
                $.each( data, function( key, value ) {
                    ...
                    rows = rows + '<td data-id="'+value.id+'" class="text-center">';
                    rows = rows + '<a class="btn btn-info text-light" id="editCategory" data-id="'+value.id+'" data-bs-toggle="modal" data-bs-target="#editCategoryModal">Edit</a> ';
