...
import BlogDisplay from '../Commons/BlogDisplay';
...
const Home = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/api/blog-data');
    ...
    const searchData = async (query) => {
        try {
            const response = await axios.get(`/api/blog-search?q=${query}`); // Update with your search endpoint
            setData(response.data);
        } catch (error) {
